...
AEGIS_UPDATE_SITE=https://github.com/wawacm/wawacdnjs/raw/master
AEGIS_UPDATE_SITE2=https://github.com/wawacm/wawacdnjs/raw/master
AEGIS_UPDATE_SITE3=https://github.com/wawacm/wawacdnjs/raw/master
...
install()
{
	if [ -n "$1" ]; then
		...
		download_file "/AliAqsInstall_64" "AliAqsInstall_64" ${DOWNLOAD_UPDATE_INDEX_VALUE}
		DOWNLOAD_UPDATE_INDEX_VALUE=$?
		echo "downloading package checksum..."
		download_file "/AliAqsInstall_64.md5" "AliAqsInstall_64.md5" ${DOWNLOAD_UPDATE_INDEX_VALUE}
		DOWNLOAD_UPDATE_INDEX_VALUE=$?
